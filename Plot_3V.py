...
#plt.title(get_title (save_direc))
plt.xlabel(r"$ \frac{1}{Ta^{\frac{1}{2}} sin \phi}   \frac{\partial(\rho_{ref} \left\langle\overline{uv}\right\rangle)} {\partial z Ta^{0.5}}$")
plt.ylabel(r"$z$")
plt.ylim(0,max(z))
plt.xlim(find_limit (dRS_uv_z3))
plt.tight_layout()
...
#plt.title(get_title (save_direc))
plt.xlabel(r"$ \frac{1}{Ta^{\frac{1}{2}} sin \phi}   \frac{\partial(\rho_{ref} \left\langle\overline{uw}\right\rangle)} {\partial z Ta^{0.5}}$")
plt.ylabel(r"$z$")
plt.ylim(0,max(z))
plt.xlim(find_limit (dRS_uw_z3))
plt.tight_layout()
...
#plt.title(get_title (save_direc))
plt.xlabel(r"$ \frac{1}{Ta^{\frac{1}{2}} sin \phi}   \frac{\partial(\rho_{ref} \left\langle\overline{vw}\right\rangle)} {\partial z Ta^{0.5}}$")
plt.ylabel(r"$z$")
plt.ylim(0,max(z))
...
plt.plot(u_bar_z3, z, 'b')
plt.title(get_title (save_direc))
plt.xlabel(r"$ \overline{u} $")
plt.ylabel(r"$z$")
plt.ylim(0,ana_t[-1])
plt.xlim(find_limit (u_bar_z*1.1))
plt.tight_layout()
...
plt.ylabel(r"$z$")
plt.ylim(0,ana_t[-1])
plt.xlim(find_limit (v_bar_z*1.1))
